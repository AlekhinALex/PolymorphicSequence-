...
protected:
    ...
    void TestConstructors() override
    {
        ...
        ListSequence<T> copy(*dynamic_cast<ListSequence<T> *>(this->sequence));
    ...
    {
        ListSequence<T> &seqRef = *dynamic_cast<ListSequence<T> *>(this->sequence);
        ...
        // Test const operator[]
        const ListSequence<T> &constRef = seqRef;
